        ...
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <div class="row border-bottom border-3 p-1 m-1">
                    ...
                    <div class="col noPadding d-flex justify-content-end mb-2"><a href="/admin/word/add" class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4">Dodaj słowo</a></div>
                </div>
                <table class="table border-bottom schedules-content">
                    <thead>
                    <tr class="d-flex text-color-darker">
                        <th scope="col" class="col-1"></th>
                        <th scope="col" class="col-9">Dane użytkownika</th>
                    ...
                    <c:forEach items="${users}" var="users">
                        <tr class="d-flex">
                            ...
                            <td class="col-8">${users.fullName}</td>
                            <td class="col-3 d-flex align-items-center justify-content-center flex-wrap">
                                <a href="remove?toRemoveId=${users.id}" class="btn btn-danger rounded-0 text-light m-1" onclick="return confirm('Czy na pewno chcesz usunąć to słowo?');">Usuń</a>
                                <a href="edit?idToEdit=${users.id}" class="btn btn-warning rounded-0 text-light m-1">Edytuj</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
