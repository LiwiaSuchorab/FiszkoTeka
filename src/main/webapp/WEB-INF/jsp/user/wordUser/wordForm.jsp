            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <form:hidden path="id"/>
                    <security:authorize access="isAuthenticated()">
                        authenticated as <security:authentication property="principal.fullName" />
                    </security:authorize>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <form:select path="users.id" items="${users}" itemLabel="FullName" itemValue="id"/><br>
                        <form:errors path="users" cssClass="error"/> <br>
                    </div>
