        ...
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <div class="row border-bottom border-3 p-1 m-1">
                    ...
                    <div class="col noPadding d-flex justify-content-end mb-2"><a href="/user/wordUser/add" class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4">Dodaj słowo</a></div>
                </div>
                <table class="table border-bottom schedules-content">
                    ...
                    <tbody class="text-color-lighter">
                    <c:forEach items="${wordUser}" var="wordUser">
                        <tr class="d-flex">
                            <th scope="row" class="col-1"></th>
                            <td class="col-2">${wordUser.firstWord}</td>
                            <td class="col-2">${wordUser.secondWord}</td>
                            <td class="col-4">${wordUser.firstSentence}</td>
                            <td class="col-3 d-flex align-items-center justify-content-center flex-wrap">
                                <a href="remove?toRemoveId=${wordUser.id}" class="btn btn-danger rounded-0 text-light m-1" onclick="return confirm('Czy na pewno chcesz usunąć to słowo?');">Usuń</a>
                                <a href="edit?idToEdit=${wordUser.id}" class="btn btn-warning rounded-0 text-light m-1">Edytuj</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
