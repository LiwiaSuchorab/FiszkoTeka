                    ...
                    <c:forEach items="${word}" var="word">
                        <tr class="d-flex">
                            ...
                            <td class="col-3 d-flex align-items-center justify-content-center flex-wrap">
                                <sec:authorize access="hasAnyAuthority('ADMIN')">
                                <%--<a href="/admin/word/remove?toRemoveId=${word.id}" class="btn btn-danger rounded-0 text-light m-1" onclick="return confirm('Czy na pewno chcesz usunąć to słowo?');">Usuń</a>--%>
                                <a href="/admin/word/edit?idToEdit=${word.id}" class="btn btn-warning rounded-0 text-light m-1">Edytuj</a>
                                </sec:authorize>
                            </td>
                        </tr>
                    </c:forEach>
